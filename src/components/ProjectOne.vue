...
<template>
    <div class="w-full ">
        <div class="">
            ...
            <div class=" relative w-11/12 sm:w-11/12 md:w-11/12 lg:w-3/5 m-auto top-0 ">
                <div class="z-10 absolute w-full top-0 bg-eerieBlack rounded-lg ">
                    <!--close icon-->
                    ...
                    <div class="pt-2 pb-5">
                     ...
                     <!--project details-->
                    <div class="w-11/12 mx-auto flex justify-between gap-2 pb-5">
